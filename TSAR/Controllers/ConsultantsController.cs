...
namespace TSAR.Controllers
{
    ...
    public class ConsultantsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ConsultantNum,FirstName,LastName,FullName,ContactNumber,ConsultantAddress,Email,ConsultantType,CommissionId,Password,ConsultantUserName,Gender,LeaveBalance,AnnualLeaveBalance,MaternityLeaveBalance,SickLeaveBalance,FamilyResponsibilityBalance,PaternityLeaveBalance")] Consultant consultant)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                consultant.AnnualLeaveBalance = 21;
                consultant.MaternityLeaveBalance = 120;
                consultant.PaternityLeaveBalance = 120;
                consultant.SickLeaveBalance = 13;
                consultant.FamilyResponsibilityBalance = 3;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ConsultantNum,FirstName,LastName,FullName,ContactNumber,ConsultantAddress,Email,ConsultantType,CommissionId,Password,ConsultantUserName,Gender,LeaveBalance,AnnualLeaveBalance,MaternityLeaveBalance,SickLeaveBalance,FamilyResponsibilityBalance,PaternityLeaveBalance ")] Consultant consultant)
        {
            if (ModelState.IsValid)
            {
