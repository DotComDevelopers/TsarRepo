...
namespace TSAR.Api
{
    public class MobileApplicationUsersController : ApiController
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        // GET: api/MobileApplicationUsers
        public IQueryable<ApplicationUser> GetApplicationUsers()
        {
            return db.ApplicationUsers;
        }

        // GET: api/MobileApplicationUsers/5
        ...
        // PUT: api/MobileApplicationUsers/5
        ...
        // POST: api/MobileApplicationUsers
        [ResponseType(typeof(ApplicationUser))]
        ...
        // DELETE: api/MobileApplicationUsers/5
        [ResponseType(typeof(ApplicationUser))]
