...
namespace TSAR.Api
{
    public class MobileCommentsController : ApiController
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        // GET: api/MobileComments
        public IQueryable<Comment> GetComments()
        {
            return db.Comments;
        }

        // GET: api/MobileComments/5
